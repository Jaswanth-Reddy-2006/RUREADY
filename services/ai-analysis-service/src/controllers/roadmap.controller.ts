// ═══════════════════════════════════════════════════════════════
// AI & Analysis Microservice — Career Roadmap Controller
// ═══════════════════════════════════════════════════════════════
...
export const roadmapController = {
  async generate(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const roadmap = await roadmapService.generateRoadmap(userId, rolePath, targetCompanyTier, customTechStack);
  ...
  async submitNodeAttempt(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const { codeAnswer, verbalAnswer } = req.body;
