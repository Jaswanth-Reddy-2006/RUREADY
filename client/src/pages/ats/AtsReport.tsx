        ...
        <Card className="p-6 sm:p-8 bg-white border-[#DCE7F2] shadow-sm rounded-3xl space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#EFFAFD] border border-[#4A8BDF]/30 text-[#4A8BDF] text-xs font-bold font-display">
            ...
            <div className="flex shrink-0 items-center gap-4 bg-[#EFFAFD] p-5 rounded-2xl border border-[#DCE7F2]">
              <div className="relative w-20 h-20 flex items-center justify-center">
                ...
                <div className="absolute flex flex-col items-center">
                  ...
                  <span className="text-[9px] font-bold text-[#A0006D] uppercase">ATS Match</span>
                </div>
              </div>

              <div className="space-y-1">
                <span className="text-xs font-bold text-[#11183D] block font-display">
                  {report.matchScore >= 80 ? 'Exceptional Alignment' : report.matchScore >= 65 ? 'Moderate Match' : 'Gap Opportunities'}
                </span>
          ...
          <div className="pt-4 border-t border-[#DCE7F2] flex flex-wrap items-center justify-between gap-4">
            <span className="text-xs font-bold text-[#526078] font-display">
              Ready to practice? Launch a mock interview tailored to this job posting:
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="p-6 bg-white border-[#DCE7F2] shadow-sm rounded-3xl space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#168A62] block mb-2 font-display">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {report.matchedSkills.map((skill, idx) => (
                    <span
                      key={idx}
                      className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-[#168A62]/10 text-[#168A62] border border-[#168A62]/20"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="pt-2 border-t border-[#DCE7F2]">
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#A0006D] block mb-2 font-display">
                  ⚠ Missing Critical Skills ({report.missingSkills.length})
                </span>
                <div className="flex flex-wrap gap-1.5">
          ...
          <Card className="p-6 bg-white border-[#DCE7F2] shadow-sm rounded-3xl space-y-4">
            <h3 className="text-sm font-bold font-display text-[#11183D] flex items-center gap-2">
              ...
              <span>ATS Formatting & Parser Audits</span>
            </h3>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[#526078]">
                AI-optimized resume bullets injected with STAR methodology and metrics.
              </p>
            </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#F8EAF4] border border-[#A0006D]/30 space-y-2 relative">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 bg-white hover:bg-[#F8EAF4] text-[#A0006D] rounded-lg text-[10px] font-bold border border-[#A0006D]/30 transition-all cursor-pointer"
                      >
                        {copiedIndex === idx ? (
                          <>
                            <Check size={10} className="text-[#168A62]" /> Copied!
                          </>
                        ) : (
                          <>
                            <Copy size={10} /> Copy Bullet
                          </>
                        )}
                      </button>
                    </div>
        ...
        <Card className="p-6 bg-white border-[#DCE7F2] shadow-sm rounded-3xl space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold font-display text-[#11183D] flex items-center gap-2">
              ...
              <span>Job-Specific Interview Questions Generated</span>
            </h3>
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[#4A8BDF] text-white uppercase">
