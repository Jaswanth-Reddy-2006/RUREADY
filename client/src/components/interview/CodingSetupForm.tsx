    ...
    <div className="relative mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {isSubmitting && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-navy-deep/70 backdrop-blur-md">
          <div className="mx-4 max-w-md w-full rounded-3xl border border-navy-border/60 bg-navy-deep p-8 text-center shadow-card-dark">
      ...
      <div className="mb-6">
        <Link 
          to="/dashboard"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-warm-muted hover:text-navy-deep transition-colors font-display"
        >
      ...
      {/* Main Card */}
      <Card padding="lg" className="shadow-card border-warm-border bg-white space-y-7">
        
        {/* Validation Alert */}
        {validationError && (
          <div className="flex items-start gap-3 rounded-2xl bg-red-50 border border-status-error/25 p-4 text-xs text-status-error shadow-subtle font-body">
        ...
        <div className="space-y-3.5">
          <div className="border-b border-warm-border pb-3">
            <h3 className="text-sm font-bold font-display text-navy-deep">
              1. Difficulty Tier
            </h3>
                ...
                <button
                  ...
                  className={`text-left p-4 rounded-2xl border transition-all flex flex-col justify-between min-h-[140px] cursor-pointer group ${
                    isSelected
                      ...
                      : 'border-warm-border bg-white hover:border-orange-primary/30 hover:bg-warm-surface/50'
                  }`}
                >
                  <div className="flex items-center justify-between w-full">
                    <div className={`p-2 rounded-xl shrink-0 ${isSelected ? 'bg-orange-primary text-white shadow-sm' : 'bg-warm-surface text-navy-deep'}`}>
                  ...
                  <div className="mt-3 space-y-1">
                    <h4 className="text-xs font-bold font-display text-navy-deep">{meta.title}</h4>
                    <p className="text-[11px] leading-relaxed text-warm-muted font-body">
                      {meta.desc}
                    </p>
                  </div>
                </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-warm-border">
          
          <div className="space-y-2.5">
            <div className="flex items-center justify-between">
              <label className="text-xs font-semibold uppercase tracking-wider text-navy-deep/70 font-display">
                Problem Count
              </label>
              <span className="text-xs font-bold bg-orange-soft text-orange-bright px-2.5 py-0.5 rounded-full font-mono">
            ...
            />
            <div className="flex justify-between text-[10px] text-warm-muted font-mono">
              <span>1 Problem</span>
          ...
          <div className="space-y-2.5">
            <div className="flex items-center justify-between">
              <label className="text-xs font-semibold uppercase tracking-wider text-navy-deep/70 font-display flex items-center gap-1">
        ...
        <div className="space-y-3 pt-4 border-t border-warm-border">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-navy-deep/70 font-display">
              Algorithmic Focus Topics <span className="text-status-error">*</span>
            </h3>
            <span className="text-[11px] text-warm-muted font-body">Select at least one</span>
          </div>

          <div className="flex flex-wrap gap-2 p-4 rounded-2xl border border-warm-border bg-warm-surface/40 max-h-48 overflow-y-auto">
      ...
      {/* Security Note */}
      <div className="mt-6 flex justify-center items-center gap-2 text-xs text-warm-muted font-body">
